            ...
            <form action="{{ route('techniciens.store') }}" method="post">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="mail" name="technicien-email" id="text" class="form-control" value="{{ old('technicien-email') }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="technicien-address" id="date-demande" class="form-control" value="{{ old('technicien-address') }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="technicien-phone" id="name" class="form-control" value="{{ old('technicien-phone') }}">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="number" name="technicien-experience" id="name" class="form-control" value="{{ old('technicien-experience') }}">
